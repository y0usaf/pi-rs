...
Dynamic tools/messages/flags/shortcuts/providers and their live registry effects are closed; the ExtensionAPI runtime action/view methods are bound per-session with reload recovery. Remaining open work is the async argument-completion and message-renderer fallthrough slices (shared with 9.5/9.8).
