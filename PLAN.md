...
- [ ] **8. Complete coding-agent AI/auth compatibility.** Port the providers
      ...
      **Remaining:** finish `openai-codex-responses` WebSocket, cached continuation,
      diagnostics/fallback, timeout/resource cleanup, and registry dispatch; add
      deterministic differential replays + dispatch for `azure-openai-responses`,
