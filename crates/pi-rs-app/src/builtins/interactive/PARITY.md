...
| `interactive-mode.ts` lifecycle | `builtins/interactive.lua`, `pi-rs-tui/src/process.rs` | start/input/resize/signals/stream concurrency/cleanup + inherited child terminal release/reacquire; suspend open |
