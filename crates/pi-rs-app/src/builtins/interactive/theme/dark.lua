-- Pi v0.79.0 dark theme translated from the pinned JSON definition.
return {
  name = "dark",
  vars = {
    cyan = "#00d7ff", blue = "#5f87ff", green = "#b5bd68",
    red = "#cc6666", yellow = "#ffff00", text = "#d4d4d4",
    gray = "#808080", dimGray = "#666666", darkGray = "#505050",
    accent = "#8abeb7", selectedBg = "#3a3a4a", userMsgBg = "#343541",
  ...
  colors = {
    ...
    success = "green", error = "red", warning = "yellow", muted = "gray",
    dim = "dimGray", text = "text", thinkingText = "gray",
    selectedBg = "selectedBg", userMessageBg = "userMsgBg", userMessageText = "text",
    customMessageBg = "customMsgBg", customMessageText = "text", customMessageLabel = "#9575cd",
    toolPendingBg = "toolPendingBg", toolSuccessBg = "toolSuccessBg", toolErrorBg = "toolErrorBg",
    toolTitle = "text", toolOutput = "gray",
