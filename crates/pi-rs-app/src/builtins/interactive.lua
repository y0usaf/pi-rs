...
-- PLAN 9.7/9.10): require + rebind the closures the frontend wiring
...
-- Rebind the compaction/branch-summary/bash policies onto the pack-local
-- EXTENSION_POLICY table so extensions.lua's context-usage slice and product
-- wiring keep resolving them.
